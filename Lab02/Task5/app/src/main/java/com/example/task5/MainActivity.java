...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dishAdapter = new DishAdapter(MainActivity.this, R.layout.dish_item, foodList);
        ...
        addDish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dish newFood = new Dish(foodName.getText().toString(), thumbPic[(int)thumbnail.getSelectedItemId()], promotion.isChecked());
